---
title: "Aula 2-1 - Controle de Fluxo"
...
A ideia do controle de fluxo é controlar (!) o fluxo (!) sequencial de instruções dada ao computador. Se digo ao computador, some 1/3, depois subtrai 1/3 etc., ele executará os comandos nessa ordem. Porém, posso querer controlar a sequencia dos comandos.
